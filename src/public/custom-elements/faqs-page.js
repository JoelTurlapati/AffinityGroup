...
const FAQS = [
  {
    q: 'Do I have to live in Northeast Ohio?',
    a: 'Although roughly 40% of our clients live in Northeast Ohio, we work with clients throughout the state and throughout the country. Our technology integrations make working with clients 3,000 miles away as simple as working with clients down the street.'
  },
  {
    q: 'What actually is a fiduciary / financial advisor?',
    a: 'A fiduciary financial advisor is legally obligated to put the client\'s best interest ahead of their own. As compared to the majority of financial advisors who are brokers — brokers are only required to show that they made a suitable recommendation for a client and did no harm.'
  },
  {
    q: 'How can you help me with my financial life?',
    a: 'When it comes to a Fiduciary vs. a Financial Advisor we can help you in many areas of your financial life. From insurance strategies and estate planning to real estate investing and investment accounts. As a Fiduciary financial planner we are bound by law to put your financial needs above our own so you always know that we are doing the best work possible for your personal situation.'
  },
  {
    q: 'What makes you different than other advisors?',
    a: 'What makes us different as a firm is our connections. When you become a client at The Affinity Group we give you access to the resources and specialists in every area of financial planning. Our Financial Advisor Scott Lowe will provide you with information, direction, and guidance in your financial life.'
  },
  {
    q: 'Do you help me with investing?',
    a: 'Of course we do. The difference is that we help with just more than your average advisory firm. We help in all areas of investing like investment accounts, real estate investing, life insurance, and many other things that you won\'t get anywhere else when it comes to personalized financial advisory.'
  },
  {
    q: 'Which financial advisor should I use?',
    a: 'When thinking about which financial advisor you should choose, you should consider whether a fiduciary would be a better fit for you. A fiduciary is legally obligated to make decisions and provide guidance for the benefit of the client — not for the purpose of earning compensation from the client.'
  },
  {
    q: 'What if I live in Akron?',
    a: 'It\'s perfectly fine if you live in Akron. We are a fee-based fiduciary financial advising firm that can help everyone no matter where they live. Whether you are looking for a financial advisor, a fiduciary, or a financial planner in Akron, Ohio — we are all of those things and can help you with all aspects of your financial life.'
  }
];

// ─── FAQsPage Component ───────────────────────────────────────────────────────

class FAQsPage extends HTMLElement {
  connectedCallback() {
...
faqs-page{display:block;font-family:'Inter',sans-serif;color:#1a1a1a}
...
.faqs-hero__bar { width: 56px; height: 3px; background: #C9A84C; margin: 0 auto 28px; }

/* ── FAQ ACCORDION ── */
.faqs-main {
  padding: 88px 32px 96px; background: #fff;
}
.faqs-main__inner { max-width: 820px; margin: 0 auto; }

.faq-item {
  border-bottom: 1px solid #e8f0f2;
}
.faq-item:first-child { border-top: 1px solid #e8f0f2; }
...
.faq-question span:first-child {
  font-family: 'Playfair Display', serif;
  font-size: 1.12rem; font-weight: 600; color: #145568; line-height: 1.4;
}
.faq-question:hover span:first-child { color: #1D7080; }

.faq-icon {
  flex-shrink: 0;
  width: 32px; height: 32px; border-radius: 50%;
  background: #E6F4F7; color: #1D7080;
...
.faq-item.open .faq-icon {
  background: #1D7080; color: #fff; transform: rotate(45deg);
}
...
.faq-answer p {
  font-size: .98rem; line-height: 1.9; color: #4a5a5e;
  border-left: 3px solid #C9A84C; padding-left: 20px;
}

/* ── CTA STRIP ── */
.faqs-cta {
  padding: 80px 32px; background: #F0F8FA; text-align: center;
}
.faqs-cta h2 {
  font-family: 'Playfair Display', serif;
  font-size: clamp(1.4rem, 2.8vw, 2rem);
  color: #145568; margin-bottom: 12px;
}
.faqs-cta p { font-size: .95rem; color: #5a6a6e; margin-bottom: 32px; }
.faqs-btn {
...
.faqs-btn:hover { background: #145568; }
...
<main style="padding-top:72px">
  ...
  <section class="faqs-hero">
    <div class="faqs-hero__bar"></div>
    <h1>Frequently Asked Questions</h1>
    <p>Get answers to the most common questions we hear from clients and prospective clients.</p>
  </section>

  <!-- Accordion -->
  <section class="faqs-main">
    <div class="faqs-main__inner">
      <div class="faq-list">
        ${faqsHTML}
      </div>
    </div>
  ...
  <section class="faqs-cta">
    ...
    <p>We&rsquo;re happy to answer anything during a complimentary 15-minute introduction call.</p>
    <a href="/contact" class="faqs-btn">Schedule a Free Intro Call</a>
  </section>
...
customElements.define('faqs-page', FAQsPage);
